...
Shader "OldSchoolPlus"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color42 = IsGammaSpace() ? float4(0.3127408,0.7924528,0.1233535,0) : float4(0.07970664,0.5911142,0.01403686,0);
			float4 color38 = IsGammaSpace() ? float4(0.1191118,0.5471698,0,0) : float4(0.01324896,0.2603273,0,0);
			float2 uv_TextureSample0 = i.uv_texcoord * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
			o.Emission = ( ( ( ( max( dotResult3 , 0.0 ) * color6 ) + pow( max( dotResult22 , 0.0 ) , _Specular ) ) * color25 ) + ( ( ( ( temp_output_29_0 * color31 ) + ( ( ( 1.0 - temp_output_29_0 ) - temp_output_35_0 ) * color42 ) ) + ( temp_output_35_0 * color38 ) ) * tex2D( _TextureSample0, uv_TextureSample0 ).r ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18500
88;203;1280;713;698.8896;242.2579;1.6742;True;True
...
Node;AmplifyShaderEditor.SamplerNode;48;-348.3044,826.8322;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;False;0;False;-1;None;eabfa8d88fe328f4b952fb81f530c4a4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=E682874B95A6AE812777C689FE96C57A9F01E08A