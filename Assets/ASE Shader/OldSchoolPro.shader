...
Shader "OldSchoolPro"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( ( ( ( ( max( dotResult4 , 0.0 ) * _BaseColor ) + pow( max( dotResult16 , 0.0 ) , _Specular ) ) * _LightCol ) + ( ( ( temp_output_27_0 * _EnvUpCol ) + ( ( ( 1.0 - temp_output_27_0 ) - temp_output_31_0 ) * _EnvMidCol ) + ( temp_output_31_0 * _EnvDownCol ) ) * tex2D( _Occlusuion, uv_Occlusuion ) ) ) * ( tex2DNode45.r * max( dotResult55 , 0.0 ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18500
0;0;1536;795;3102.363;-923.1956;1.773316;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;59;-2233.318,1489.383;Inherit;False;1446.514;582.8352;Normal;10;45;50;47;46;55;51;52;56;57;58;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;45;-2183.318,1539.383;Inherit;True;Property;_NormalMap;NormalMap;7;0;Create;True;0;0;False;0;False;-1;None;0c8ba2f243fb4274e8a225003f437ace;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldToTangentMatrix;46;-2121.882,1943.895;Inherit;False;0;1;FLOAT3x3;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;50;-1821.533,1731.618;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.InverseOpNode;47;-1867.113,1942.807;Inherit;False;1;0;FLOAT3x3;0,0,0,0,1,0,0,0,1;False;1;FLOAT3x3;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;52;-1612.533,1891.618;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-1570.533,1730.618;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3x3;0,0,0,0,1,0,0,0,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-1318.403,1917.535;Inherit;False;Constant;_Float5;Float 5;8;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DotProductOpNode;55;-1345.533,1732.618;Inherit;False;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;56;-1116.403,1732.535;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;58;-972.7747,1573.175;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;280.8075,1009.857;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=EBCC51A62BFD27F329BBE6A74F0B647928120539