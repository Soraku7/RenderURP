...
Shader "3ColAmbient"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_8_0 = ( ase_worldNormal.y * -1.0 );
			o.Emission = ( ( ( _EnvUpCol * max( 0.0 , ase_worldNormal.y ) ) + ( max( ( ( 1.0 - ase_worldNormal.y ) - temp_output_8_0 ) , 0.0 ) * _EnvSideCol ) ) + ( max( temp_output_8_0 , 0.0 ) * _EnvDownCol ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18500
142.4;101.6;1210.4;682.2;679.4728;-144.8769;1.6;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-147.6754,388.2209;Inherit;False;Constant;_Float3;Float 3;0;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;22;142.5988,379.3035;Inherit;False;Property;_EnvSideCol;EnvSideCol;0;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;7;-391.8875,-216.1024;Inherit;False;Property;_EnvUpCol;EnvUpCol;1;0;Create;True;0;0;False;0;False;0.5283019,0,0,0;0.5283019,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;14;-236.5638,756.7187;Inherit;False;Property;_EnvDownCol;EnvDownCol;2;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=3396DA793E64627D36A96FE926F6D5ADA4D63ADD