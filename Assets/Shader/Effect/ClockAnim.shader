Shader "Unlit/ClockAnim"
{
    Properties
    {
        ...
        [Header(Clock)]
        _HourHandAngle ("时针角度" , Range(0 , 360)) = 0
        _MinuteHandAngle ("分针角度" , Range(0 , 360)) = 0
        _SecondHandAngle ("秒针角度" , Range(0 , 360)) = 0
        _RotateOffset ("旋转偏移" , Range(0 , 10)) = 0
    }
    SubShader
    {
